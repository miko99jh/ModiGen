...
file1_path = f'result/GPT4o/results_analysis_model.json'
file2_path = f'result/feedback-GPT4o/results_analysis_model.json'
output_path = f'result/feedback-GPT4o/results_analysis_model_plus.json'
